...
export function SettingsModal({ open, onOpenChange }: SettingsModalProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="p-0 max-w-3xl overflow-hidden max-h-[80vh] overflow-y-auto top-[50%] translate-y-[-50%]">
        <div className="grid grid-cols-1 lg:grid-cols-2 lg:grid-cols-[1fr_3fr]">
